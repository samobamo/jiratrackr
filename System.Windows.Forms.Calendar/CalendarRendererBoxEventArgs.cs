...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarRendererEventArgs
    {
        ...
        public CalendarRendererBoxEventArgs(CalendarRendererEventArgs original, Rectangle bounds, string text, string header, TextFormatFlags flags)
         : this(original)
        {
            Bounds = bounds;
            Text = text;
        ...
        public CalendarRendererBoxEventArgs(CalendarRendererEventArgs original, Rectangle bounds, string text, Color textColor, Font font)
            : this(original)
        {
            Bounds = bounds;
            Text = text;
